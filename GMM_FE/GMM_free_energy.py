...
class free_energy(object):
					...
					if self.mixture_of_landscapes_:
						if i_split == 0:
							for i_iter in range(self.n_iterations_):
								...
								list_of_validation_data.append(data)
					else:
	...
	def visualize(self,title="Free energy landscape", fontsize=22, savefig=True, xlabel='x', ylabel='y', vmax=7.5, n_contour_levels=15):
